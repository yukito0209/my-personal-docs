...
// 默认模型尺寸 (可以根据需要调整或在具体助手配置中覆盖)
const DEFAULT_MODEL_WIDTH = Math.round(300 * (2 / 3));
const DEFAULT_MODEL_HEIGHT = Math.round(440 * (2 / 3));

export const assistants: AssistantConfig[] = [
  {
    id: "amiya",
    name: "阿米娅",
    modelPath: "/live2d/喜多/归去来兮.model3.json",
