...
export function CustomMusicPlayer() {
  ...
  if (isLoading) {
    return (
      <div className="w-full h-full rounded-lg border bg-card p-4 shadow-sm glass-effect flex items-center justify-center">
  ...
  return (
    <div className="w-full h-full rounded-lg border bg-card p-4 shadow-sm glass-effect flex flex-col justify-between">
      <div className="flex flex-col space-y-4 flex-grow">
        {/* 专辑封面 */}
        <div className="relative w-full pt-[100%] rounded-lg overflow-hidden bg-black/5 group">
